...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210419_vestanesiaagrimart_023797bd27242d282644_20210419031645_archive.zip';
	const ARCHIVE_SIZE		 = '56294544';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '023797b-19031645';
    const SECONDARY_PACKAGE_HASH = 'c3481c0-19031645';
	const VERSION			 = '1.4.0';
