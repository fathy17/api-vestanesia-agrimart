...
<!-- <table style="width: 100%; color: inherit;"> -->
	...
	<?php if ( ! empty( $billing_address ) ) { ?>
		<td style="width: <?php echo esc_attr( $width ); ?>;">
			<h2 class="title-billing" style="color: inherit; display: block; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 10px 18px 0;">
		...
		<td style="width: <?php echo esc_attr( $width ); ?>;">
			<h2 class="title-shipping" style="color: inherit; display: block; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 0 18px;">
