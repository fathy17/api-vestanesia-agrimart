		...
		<td style="height: 18px;border-color: inherit;" valign="top">
		  <address style="padding: 12px;border: 1px solid;border-color:inherit;">
			<span style="font-size: 14px; color: inherit;">
			  <?php _e( $billing_address, 'woocommerce' ); // phpcs:ignore WordPress.Security.EscapeOutput.UnsafePrintingFunction, WordPress.Security.EscapeOutput.OutputNotEscaped ?>
			</span>
		  </address>
		</td>
	  </tr>
	...
	<tbody style="border-color: inherit;">
	  <tr style="height: 18px;border-color: inherit;">
		<td style="height: 18px;border-color: inherit;" valign="top">
		  <address style="padding: 12px;border: 1px solid;border-color:inherit;">
			<span style="font-size: 14px; color: inherit;">
			  <?php _e( $shipping_address, 'woocommerce' ); // phpcs:ignore WordPress.Security.EscapeOutput.UnsafePrintingFunction, WordPress.Security.EscapeOutput.OutputNotEscaped ?> 
			</span>
		  </address>
		</td>
	  </tr>
