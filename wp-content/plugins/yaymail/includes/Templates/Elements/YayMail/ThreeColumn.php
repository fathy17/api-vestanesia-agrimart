...
<table
	...
	"
	class="web-main-row nta-row-three-column"
	id="web<?php echo esc_attr( $id ); ?>"
  >
	<tbody>
	  <tr>
		<td
		  id="web-<?php echo esc_attr( $id ); ?>-three-columns"
		  class="web-three-columns"
		  align="left"
		  ...
		  '
		>
		  <div class="web-three-columns-row" style="min-height: 10px">
			<table style="width: 100%">
			  <tr>
				<td valign="top" 
					class="nta-three-column-items"  
				...
				>
				 <?php
					foreach ( $attrs['column1'] as $key => $el ) {
						do_action( 'Yaymail' . $el['type'], $args, $el['settingRow'], $general_attrs, $el['id'] );
					}
					?>
				</td>
				<td valign="top" 
