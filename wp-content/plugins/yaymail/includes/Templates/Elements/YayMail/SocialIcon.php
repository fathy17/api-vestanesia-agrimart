...
<table
	...
	border="0"
	align="center"
	style="display: table; background-color: <?php echo esc_attr( $attrs['backgroundColor'] ); ?>; <?php echo esc_attr( 'min-width:' . $general_attrs['tableWidth'] . 'px' ); ?>"
	class="web-main-row"
	  ...
	  <tr>
		...
		<div style="min-height: 4px"></div>
			...
			foreach ( $attrs['iconSocialsArr'] as $key => $el ) {
				...
				$margin_left = ( 0 == $key ) ? '0px' : $attrs['iconSpacing'] . 'px';
				?>
				<a 
