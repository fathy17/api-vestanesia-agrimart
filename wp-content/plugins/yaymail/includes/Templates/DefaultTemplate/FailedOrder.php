	...
	public static function getTemplates() {
      ...
      <body style="background: rgb(236, 236, 236); padding: 0;">
		...
		if ( class_exists( 'WC_Subscription' ) ) {
		 ...
		 $html .= '<table width="605px" cellspacing="0" cellpadding="0" border="0" align="center" id="web0fdff7fe-4390-4504-8611-299c6c05cfa6" class="web-main-row" style="display: table; background-color: rgb(255, 255, 255); width: 605px;">
              <tbody>
                  <tr>
                      <td id="web-0fdff7fe-4390-4504-8611-299c6c05cfa6-billing-address" align="left" class="web-billing-address" style="font-size: 13px;  line-height: 22px; word-break: break-word; font-family: Helvetica, Roboto, Arial, sans-serif; padding: 12px 50px 15px;">
          ...
          <table width="605px" cellspacing="0" cellpadding="0" border="0" align="center" id="webdff795d0-6d11-43a7-8896-c84a2a5b7c98" class="web-main-row" style="display: table; background-color: rgb(236, 236, 236); width: 605px;">
              <tbody>
                  <tr>
                      <td id="webdff795d0-6d11-43a7-8896-c84a2a5b7c98-shipping-address" align="left" class="web-shipping-address" style="font-size: 13px;  line-height: 22px; word-break: break-word; font-family: Verdana, Geneva, sans-serif; padding: 15px 50px;">
                          <div>
      ...
      },
      {
		...
		$templates['failed_order']['html']     = $html;
