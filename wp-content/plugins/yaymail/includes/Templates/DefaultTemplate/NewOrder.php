	...
	public static function getTemplates() {
      ...
      <body style="background: rgb(236, 236, 236); padding: 0;">
							...
							<tbody>
									<tr>
											<td id="web802bfe24-7af8-48af-ac5e-6560a81345b3-shipping-address" align="left" class="web-shipping-address" style="font-size: 13px; line-height: 22px; word-break: break-word; font-family: Helvetica, Roboto, Arial, sans-serif; padding: 41px 48px;">
													<div>
															<h1 style="font-size: 30px; font-weight: 300; line-height: normal; margin: 0px; color: #ffffff;">' . $emailTitle . ': #[yaymail_order_id]</h1></div>
											</td>
									</tr>
							</tbody>
					</table>
		...
		$html .= '<table width="605px" cellspacing="0" cellpadding="0" border="0" align="center" id="webf0a42dc3-af51-4452-a9e6-a640ea8829b0" class="web-main-row" style="display: table; background-color: rgb(255, 255, 255); width: 605px;">
							<tbody>
									<tr>
											<td id="web-f0a42dc3-af51-4452-a9e6-a640ea8829b0-billing-address" align="left" class="web-billing-address" style="font-size: 13px; line-height: 22px; word-break: break-word; font-family: Helvetica, Roboto, Arial, sans-serif; padding: 15px 50px;">
					...
					<table width="605px" cellspacing="0" cellpadding="0" border="0" align="center" id="web6d8ff001-7ee7-4183-aff3-d05e4b9fb444" class="web-main-row" style="display: table; background-color: rgb(236, 236, 236); width: 605px;">
							<tbody>
									<tr>
											<td id="web6d8ff001-7ee7-4183-aff3-d05e4b9fb444-shipping-address" align="left" class="web-shipping-address" style="font-size: 13px; line-height: 22px; word-break: break-word; font-family: Verdana, Geneva, sans-serif; padding: 15px 50px;">
													<div>
		...
		*/
		...
		// Elements
		$elements_tt = '[{
      "id": "13031996-7258-42cc-ba53-7ae69638c1fe",
		  "type": "Text",
    }]';
		$elements    =
		'[{
