...
class CustomerOnHoldOrder {
	...
	public static function getTemplates() {
		...
		*/
		...
		$emailtext           = esc_html__( 'Thanks for your order. It\'s on-hold until we confirm that payment has been received. In the meantime, here\'s a reminder of what you ordered:', 'woocommerce' );
      ...
      },
      {
		...
		$templates['customer_on_hold_order']['html']     = $html;
		$templates['customer_on_hold_order']['elements'] = $elements;
		return $templates;
	}
}
