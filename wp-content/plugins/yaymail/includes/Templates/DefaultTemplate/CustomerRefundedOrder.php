...
class CustomerRefundedOrder {
	...
	public static function getTemplates() {
		...
		*/
		$emailTitle          = __( 'Order Refunded: {order_number}', 'woocommerce' );
		...
		$emailtext           = esc_html__( 'Your order on ', 'woocommerce' ) . esc_html( do_shortcode( '[yaymail_site_name]' ) ) . esc_html__( ' has been refunded. There are more details below for your reference:', 'woocommerce' );
		$additionalContent   = __( 'We hope to see you again soon.', 'woocommerce' );
      ...
      <html>
              ...
              <tbody >
                <tr >
                    <td  id="web802bfe24-7af8-48af-ac5e-6560a81345b3-shipping-address" align="left" class="web-shipping-address" style="font-size: 13px;  line-height: 22px; word-break: break-word; font-family: Helvetica, Roboto, Arial, sans-serif; padding: 36px 48px;">
                      <div >
                          <h1 style="font-size: 30px; font-weight: 300; line-height: normal; margin: 0; color: #fff;">' . $emailTitle . ' [yaymail_order_id]</h1>
                      </div>
                    </td>
                </tr>
              </tbody>
		...
		if ( class_exists( 'WC_Subscription' ) ) {
		  ...
		  $html .= '<table   width="605px" cellspacing="0" cellpadding="0" border="0" align="center" id="webf0a42dc3-af51-4452-a9e6-a640ea8829b0" class="web-main-row" style="display: table; background-color: rgb(255, 255, 255); width: 605px;">
              <tbody >
                <tr >
                    <td  id="web-f0a42dc3-af51-4452-a9e6-a640ea8829b0-billing-address" align="left" class="web-billing-address" style="font-size: 13px;  line-height: 22px; word-break: break-word; font-family: Helvetica, Roboto, Arial, sans-serif; padding: 12px 50px 15px;">
          ...
          <table   width="605px" cellspacing="0" cellpadding="0" border="0" align="center" id="webd6499e3d-d25e-48aa-8130-916bd4773208" class="web-main-row" style="display: table; background-color: rgb(236, 236, 236); width: 605px;">
              <tbody >
                <tr >
                    <td  id="webd6499e3d-d25e-48aa-8130-916bd4773208-shipping-address" align="left" class="web-shipping-address" style="font-size: 13px;  line-height: 22px; word-break: break-word; font-family: Verdana, Geneva, sans-serif; padding: 15px 50px;">
                      <div >
    ...
    ';
      ...
      },
      {
		...
		$templates['customer_refunded_order']['html']     = $html;
		$templates['customer_refunded_order']['elements'] = $elements;
		return $templates;
	}
}
